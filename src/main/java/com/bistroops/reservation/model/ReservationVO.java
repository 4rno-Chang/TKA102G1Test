...
public class ReservationVO implements java.io.Serializable {
	...
	public ReservationVO(Integer rsvNo, Integer memNo, ReservationDatetimeVO reservationdatetime, Integer seatTypeNo,
			LocalDateTime rsvCreateTime, String rsvStatus, String rsvComment) {
		super();
		this.rsvNo = rsvNo;
		this.memNo = memNo;
		this.reservationdatetime = reservationdatetime;
